...
def _validate_date_components(date_part: str) -> None:
...
def _validate_time_components(time_part: str) -> None:
...
def validate_prompt_version(v: str) -> str:
    ...
    date_part = v[:6]
    time_part = v[7:]
    _validate_date_components(date_part)
    _validate_time_components(time_part)
