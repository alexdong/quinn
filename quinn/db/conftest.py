"""Import shared fixtures from project root tests/conftest.py for quinn/db tests."""

import sys
from pathlib import Path

# Add project root to path to import from tests/conftest.py
...
try:
    ...
    def clean_db(temp_db):
        ...
        with patch("quinn.db.database.DATABASE_FILE", str(temp_db)):
    ...
    @pytest.fixture
    def setup_test_data(clean_db, test_user_data, test_conversation_data):
